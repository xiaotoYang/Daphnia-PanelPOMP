...
#constuct panelPOMP
shared_parameter =c(0.004621913, 7.991700e-04,0.0007095320,8.143122e-06)
names(shared_parameter) = c("gamma", "Theta", "sigB","sigG")

specific_mat = matrix(data = c(rep(0.875100208, 10), rep( 0.0041770577,10),
                               rep(303.5295,10)), nrow = 3, nc = 10, byrow = T, 
dim = list(rownames = c("alpha","Beta", "kf"),
...
names.of.estimated.shared.params <-  c("gamma", "Theta", "sigB","sigG")
names.of.estimated.specific.params <- c("alpha","Beta", "kf")
dent_rw.sd= 0.00125
